...
const FutLife = (() => {
  ...
  // Estrutura de ligas usada como modelo de jogo. Clubes brasileiros de B/C seguem a divisão de 2026.
  const CLUBS = [
    { id:"guarani", name:"Guarani", shortName:"GUA", strength:59, prestige:52, rivalId:"ponte-preta", country:"Brasil", flag:"🇧🇷", leagueName:"Campeonato Brasileiro — Série C", division:"3ª divisão", leagueGames:19, leagueSize:20, cupName:"Copa do Brasil", yellowThreshold:3, salaryBaseBRL:45000 },
    { id:"ponte-preta", name:"Ponte Preta", shortName:"PON", strength:61, prestige:57, rivalId:"guarani", country:"Brasil", flag:"🇧🇷", leagueName:"Campeonato Brasileiro — Série B", division:"2ª divisão", leagueGames:38, leagueSize:20, cupName:"Copa do Brasil", yellowThreshold:3, salaryBaseBRL:55000 },
    { id:"botafogo-sp", name:"Botafogo-SP", shortName:"BOT", strength:62, prestige:54, rivalId:"ituano", country:"Brasil", flag:"🇧🇷", leagueName:"Campeonato Brasileiro — Série B", division:"2ª divisão", leagueGames:38, leagueSize:20, cupName:"Copa do Brasil", yellowThreshold:3, salaryBaseBRL:60000 },
    { id:"ituano", name:"Ituano", shortName:"ITU", strength:59, prestige:51, rivalId:"botafogo-sp", country:"Brasil", flag:"🇧🇷", leagueName:"Campeonato Brasileiro — Série C", division:"3ª divisão", leagueGames:19, leagueSize:20, cupName:"Copa do Brasil", yellowThreshold:3, salaryBaseBRL:40000 },
    { id:"santos", name:"Santos", shortName:"SAN", strength:76, prestige:87, rivalId:"sao-paulo", country:"Brasil", flag:"🇧🇷", leagueName:"Campeonato Brasileiro — Série A", division:"1ª divisão", leagueGames:38, leagueSize:20, cupName:"Copa do Brasil", yellowThreshold:3, salaryBaseBRL:260000 },
    { id:"sao-paulo", name:"São Paulo", shortName:"SAO", strength:83, prestige:93, rivalId:"santos", country:"Brasil", flag:"🇧🇷", leagueName:"Campeonato Brasileiro — Série A", division:"1ª divisão", leagueGames:38, leagueSize:20, cupName:"Copa do Brasil", yellowThreshold:3, salaryBaseBRL:420000 },
    { id:"corinthians", name:"Corinthians", shortName:"COR", strength:82, prestige:94, rivalId:"palmeiras", country:"Brasil", flag:"🇧🇷", leagueName:"Campeonato Brasileiro — Série A", division:"1ª divisão", leagueGames:38, leagueSize:20, cupName:"Copa do Brasil", yellowThreshold:3, salaryBaseBRL:450000 },
    { id:"palmeiras", name:"Palmeiras", shortName:"PAL", strength:88, prestige:96, rivalId:"corinthians", country:"Brasil", flag:"🇧🇷", leagueName:"Campeonato Brasileiro — Série A", division:"1ª divisão", leagueGames:38, leagueSize:20, cupName:"Copa do Brasil", yellowThreshold:3, salaryBaseBRL:650000 },
    { id:"flamengo", name:"Flamengo", shortName:"FLA", strength:89, prestige:98, rivalId:"vasco", country:"Brasil", flag:"🇧🇷", leagueName:"Campeonato Brasileiro — Série A", division:"1ª divisão", leagueGames:38, leagueSize:20, cupName:"Copa do Brasil", yellowThreshold:3, salaryBaseBRL:720000 },
    { id:"vasco", name:"Vasco da Gama", shortName:"VAS", strength:79, prestige:90, rivalId:"flamengo", country:"Brasil", flag:"🇧🇷", leagueName:"Campeonato Brasileiro — Série A", division:"1ª divisão", leagueGames:38, leagueSize:20, cupName:"Copa do Brasil", yellowThreshold:3, salaryBaseBRL:310000 },
    { id:"benfica", name:"Benfica", shortName:"BEN", strength:86, prestige:93, rivalId:"sporting", country:"Portugal", flag:"🇵🇹", leagueName:"Primeira Liga", division:"1ª divisão", leagueGames:34, leagueSize:18, cupName:"Taça de Portugal", yellowThreshold:5, salaryBaseBRL:720000 },
    { id:"porto", name:"FC Porto", shortName:"POR", strength:85, prestige:92, rivalId:"benfica", country:"Portugal", flag:"🇵🇹", leagueName:"Primeira Liga", division:"1ª divisão", leagueGames:34, leagueSize:18, cupName:"Taça de Portugal", yellowThreshold:5, salaryBaseBRL:700000 },
    { id:"sporting", name:"Sporting CP", shortName:"SCP", strength:86, prestige:92, rivalId:"benfica", country:"Portugal", flag:"🇵🇹", leagueName:"Primeira Liga", division:"1ª divisão", leagueGames:34, leagueSize:18, cupName:"Taça de Portugal", yellowThreshold:5, salaryBaseBRL:700000 },
    { id:"real-madrid", name:"Real Madrid", shortName:"RMA", strength:94, prestige:99, rivalId:"barcelona", country:"Espanha", flag:"🇪🇸", leagueName:"LaLiga", division:"1ª divisão", leagueGames:38, leagueSize:20, cupName:"Copa del Rey", yellowThreshold:5, salaryBaseBRL:2500000 },
    { id:"barcelona", name:"Barcelona", shortName:"BAR", strength:92, prestige:99, rivalId:"real-madrid", country:"Espanha", flag:"🇪🇸", leagueName:"LaLiga", division:"1ª divisão", leagueGames:38, leagueSize:20, cupName:"Copa del Rey", yellowThreshold:5, salaryBaseBRL:2200000 },
    { id:"atletico-madrid", name:"Atlético de Madrid", shortName:"ATM", strength:88, prestige:95, rivalId:"real-madrid", country:"Espanha", flag:"🇪🇸", leagueName:"LaLiga", division:"1ª divisão", leagueGames:38, leagueSize:20, cupName:"Copa del Rey", yellowThreshold:5, salaryBaseBRL:1450000 }
  ];

  const SMALL_BRAZIL = ["guarani","ponte-preta","botafogo-sp","ituano"];
  const MID_BRAZIL = ["santos","vasco"];
  const BIG_BRAZIL = ["sao-paulo","corinthians","palmeiras","flamengo"];

  let career;

  function clubById(id) { const c = CLUBS.find(x=>x.id===id); if(!c) throw new Error(`Clube não encontrado: ${id}`); return c; }
  ...
  function competitionsFor(c,club){
    const comps=[club.leagueName,club.cupName];
    let previous=[...c.history].reverse().find(h=>h.clubId===club.id);
    if(club.country==="Brasil" && club.division==="1ª divisão"){
      const pos=previous?.leaguePosition ?? (club.strength>=84?4:club.strength>=78?9:14);
      if(pos<=6)comps.push("Copa Libertadores"); else if(pos<=12)comps.push("Copa Sul-Americana");
    } else if(["Portugal","Espanha"].includes(club.country)){
      const pos=previous?.leaguePosition ?? (club.strength>=88?3:5);
      if(pos<=4)comps.push("UEFA Champions League"); else if(pos<=6)comps.push("UEFA Europa League");
    }
    return comps;
  }
  ...
  function startSeason(c){
    ...
    const club=clubById(c.clubId), year=START_YEAR+c.seasonIndex, role=determineRole(c.overall,club,c.lastRating,c.coachTrust,c.age);
    const eventCount=club.prestige>=94?8:club.prestige>=84?7:club.prestige>=65?6:5;
    const events=buildSeasonEvents(c,eventCount);
    c.pendingSeason={yearLabel:`${year}/${String((year+1)%100).padStart(2,"0")}`,clubIdAtStart:club.id,overallStart:c.overall,reputationStart:c.reputation,roleAtStart:role,objective:seasonObjective(role),competitions:competitionsFor(c,club),events,currentEvent:0,effects:{goals:0,assists:0,tackles:0,ratingBonus:0,reputationDelta:0,formDelta:0,moraleDelta:0,coachTrustDelta:0,gamesMissed:0,developmentPenalty:0,extraIncomeBRL:0},trainingGains:{},salaryAtStart:c.salaryMonthlyBRL};
    c.lastEventKeys=events.map(e=>e.templateKey); c.lastSummary=null; c.pendingOffer=null;
  }

  function buildSeasonEvents(c,count){
    const events=[preseasonEvent(c)], used=new Set([events[0].templateKey]), recent=new Set(c.lastEventKeys||[]);
    const add=(factory)=>{ for(let i=0;i<8;i++){const e=factory(c); if(!used.has(e.templateKey)&&(!recent.has(e.templateKey)||i>=6)){used.add(e.templateKey);events.push(e);return true;}} return false; };
    let injuryAdded=false;
    if(nextRandom(c)<.17 && events.length<count){ add(injuryEvent); injuryAdded=true; }
    const club=clubById(c.clubId);
    if(club.rivalId&&nextRandom(c)<.60&&events.length<count)add(derbyEvent);
    const pool=[matchEventNormal,offFieldEvent,offFieldEvent,careerEvent,agentEvent,sponsorshipEvent,matchEventNormal];
    while(events.length<count){ const f=pick(c,pool); if(f===injuryEvent&&injuryAdded)continue; if(!add(f))add(offFieldEvent); }
  ...
  function preseasonEvent(c){
    ...
    const choices=picks.map(a=>({id:`train-${a}-${c.rngState}`,label:`Treinar ${ATTRIBUTE_LABELS[a]}`,effect:"train",attribute:a}));
    choices.push({id:`integrate-${c.rngState}`,label:"Sair com os companheiros",effect:"social"},{id:`rest-${c.rngState}`,label:"Descansar e chegar inteiro",effect:"discipline"});
  ...
  function sponsorshipEvent(c){
    const value=Math.round((10000+(c.reputation||10)*3500+c.overall*700)*rand(c,.75,1.25)/1000)*1000;
    return {id:`sponsor-${c.rngState}`,templateKey:`sponsor-${randInt(c,1,4)}`,kind:"life",title:"Proposta de patrocínio",text:`Uma marca oferece um contrato pessoal estimado em ${formatMoney(value,c.currencyPreference)} pela campanha.`,sponsorValue:value,choices:[{id:`sponsor-yes-${c.rngState}`,label:"Aceitar o patrocínio",effect:"sponsor-yes"},{id:`sponsor-no-${c.rngState}`,label:"Recusar para preservar a imagem",effect:"sponsor-no"}]};
  }

  const INJURIES=[
    {key:"bruise",name:"Contusão muscular",weight:36,min:1,max:2,penalty:.02,setback:.12},
    {key:"ankle",name:"Entorse de tornozelo",weight:24,min:3,max:6,penalty:.08,setback:.25},
    {key:"hamstring",name:"Lesão muscular posterior",weight:20,min:4,max:8,penalty:.12,setback:.28},
    {key:"shoulder",name:"Lesão no ombro",weight:9,min:5,max:10,penalty:.16,setback:.30},
    {key:"fracture",name:"Fratura",weight:6,min:10,max:18,penalty:.30,setback:.25},
    {key:"knee",name:"Lesão ligamentar no joelho",weight:5,min:14,max:24,penalty:.42,setback:.35}
  ];
  ...
  function derbyEvent(c){ const club=clubById(c.clubId), rival=clubById(club.rivalId); const defensive=c.position==="GOL"||["ZAG","VOL","LE","LD"].includes(c.position); return {id:`derby-${c.rngState}`,templateKey:"derby-decision",kind:"derby",title:`${club.name} × ${rival.name}`,text:defensive?"Seu time vence o clássico por 1–0 aos 85 minutos. O rival parte para a pressão final.":"O clássico está 0–0 aos 79 minutos. Uma jogada sua pode mudar a história.",matchState:defensive?"leading":"tied",scoreBefore:defensive?"1–0":"0–0",rivalClubName:rival.name,choices:matchChoices(c).map((x,i)=>({id:`derby-${i}-${c.rngState}`,label:x.label,attribute:x.attribute,effect:"match"}))}; }
  ...
  function resolveEventChoice(c,choiceId){
    ...
    switch(ch.effect){
      ...
      case "community":p.effects.reputationDelta+=3;p.effects.moraleDelta+=3;text="Sua participação aproxima você da torcida e melhora sua imagem.";break;
      ...
      case "fan-talk":p.effects.reputationDelta+=2;p.effects.moraleDelta+=1;text="A conversa diminui a tensão e rende respeito de parte da torcida.";break;
      case "avoid-fans":p.effects.formDelta+=1;p.effects.reputationDelta-=1;text="Você evita o confronto, mas alguns torcedores interpretam a saída como distância.";break;
      ...
      case "mentor":p.effects.moraleDelta+=2;p.effects.coachTrustDelta+=1;text="O gesto fortalece seu respeito dentro do elenco.";break;
      ...
      case "agent-break":p.effects.reputationDelta+=1;p.effects.moraleDelta+=2;text="Você troca de representante e sente que retoma o controle da carreira.";break;
      case "sponsor-yes":p.effects.extraIncomeBRL+=e.sponsorValue||0;p.effects.reputationDelta+=2;text=`Você fecha a campanha e adiciona ${formatMoney(e.sponsorValue||0,c.currencyPreference)} aos ganhos da carreira.`;break;
      ...
      case "match": { const val=attrValue(c.attributes,ch.attribute),chance=clamp(.16+val*.0073+(c.form-50)*.002+((c.morale||50)-50)*.0012-(e.kind==="derby"?.025:0),.24,.88),success=nextRandom(c)<chance; const offensive=["shooting","passing","dribbling"].includes(ch.attribute); let contribution="";
        if(success){p.effects.ratingBonus+=e.kind==="derby"?.06:.035;p.effects.reputationDelta+=e.kind==="derby"?2:1;p.effects.formDelta+=2;if(ch.attribute==="shooting"){p.effects.goals++;contribution="Você finaliza e marca.";}else if(ch.attribute==="passing"){p.effects.assists++;contribution=c.position==="GOL"?"A reposição inicia a jogada do gol.":"Seu passe deixa o companheiro em condições de marcar.";}else if(ch.attribute==="dribbling"){if(nextRandom(c)<.48){p.effects.goals++;contribution="Você vence no drible e marca.";}else{p.effects.assists++;contribution="Você elimina o marcador e cria o gol.";}}else if(ch.attribute==="tackling"){p.effects.tackles+=3;contribution="Você antecipa e corta a jogada decisiva.";}else contribution="Você faz uma grande defesa.";
        } else {p.effects.ratingBonus-=e.kind==="derby"?.025:.015;p.effects.formDelta-=1;contribution="A tentativa não funciona.";}
  ...
  function leaguePosition(c,club){ return clamp(Math.round(expectedLeaguePosition(club)+rand(c,-2.6,2.6)),1,club.leagueSize); }
  ...
  function titlesFor(c,club,pos,competitions,seasonIndex){
    ...
    let cup=.008+Math.max(0,club.strength-60)*.004; if(club.strength<65)cup*=.45; if(seasonIndex===0&&club.strength<70)cup*=.55; if(nextRandom(c)<clamp(cup,.002,.17))out.push(club.cupName);
    if(competitions.includes("Copa Libertadores")&&nextRandom(c)<clamp(.018+(club.strength-80)*.009,.01,.16))out.push("Copa Libertadores");
    if(competitions.includes("Copa Sul-Americana")&&nextRandom(c)<clamp(.025+(club.strength-74)*.009,.015,.18))out.push("Copa Sul-Americana");
    if(competitions.includes("UEFA Champions League")&&nextRandom(c)<clamp(.015+(club.strength-84)*.012,.01,.18))out.push("UEFA Champions League");
    if(competitions.includes("UEFA Europa League")&&nextRandom(c)<clamp(.025+(club.strength-80)*.010,.015,.18))out.push("UEFA Europa League"); return out;
  }
  ...
  function possibleOffer(c,stats){
    if(stats.rating<7.0&&c.age<23)return null; const current=clubById(c.clubId),amb=(stats.rating-6.8)*11+(c.overall-current.strength+4)*.45+(c.potential-c.overall)*.15+c.reputation*.06;if(amb<4||nextRandom(c)>clamp(.12+amb*.02,.14,.58))return null;
    const candidates=CLUBS.filter(x=>x.id!==current.id&&x.strength<=c.overall+13&&x.strength>=current.strength-1).map(x=>{const role=determineRole(c.overall,x,stats.rating,50,c.age),salary=meaningfulOfferSalary(c,current,x,role),step=(x.strength-current.strength)+(x.prestige-current.prestige)*.3+({Reserva:0,Rotação:1,Titular:3,Importante:5,Estrela:7}[role]||0);return{x,role,salary,step};}).filter(o=>o.step>=2||o.salary>c.salaryMonthlyBRL*1.12).sort((a,b)=>b.step-a.step);
    if(!candidates.length)return null;const o=pick(c,candidates.slice(0,Math.min(5,candidates.length)));return{clubId:o.x.id,clubName:o.x.name,strength:o.x.strength,prestige:o.x.prestige,projectedRole:o.role,salaryMonthlyBRL:o.salary,reason:o.x.strength>current.strength+3?"Um clube de patamar superior acompanha sua evolução.":"A proposta oferece uma combinação diferente de espaço esportivo e valorização salarial."};
  }

  function freeAgentOffers(c,stats){
    const current=clubById(c.clubId),score=c.overall+(stats?.rating-6.8||0)*5+c.reputation*.08;
    const candidates=CLUBS.filter(x=>x.id!==current.id&&x.strength<=score+11&&x.strength>=Math.max(58,score-12)).map(x=>{const role=determineRole(c.overall,x,c.lastRating,50,c.age),salary=salaryFor(c,x,role);return{clubId:x.id,clubName:x.name,projectedRole:role,salaryMonthlyBRL:salary,fit:Math.abs(x.strength-(c.overall+4))+rand(c,0,6)};}).sort((a,b)=>a.fit-b.fit);
    const chosen=[];candidates.forEach(x=>{if(chosen.length<3&&!chosen.some(y=>y.clubId===x.clubId))chosen.push(x);});return chosen;
  }
  ...
  function simulateNpcSeason(c,rival,label){const club=clubById(rival.clubId),start=rival.overall,raw=rival.position==="GOL"?simulateGoalkeeperStats(c,rival,club,{}):simulateFieldStats(c,rival,club,{}),pos=leaguePosition(c,club),comps=competitionsFor({history:rival.history},club),titles=titlesFor(c,club,pos,comps,c.seasonIndex),awards=awardsFor(c,rival,raw,club,titles);rival.reputation=reputationAfter(rival.reputation,raw.rating,titles,awards,{});rival.form=clamp(Math.round(rival.form+(raw.rating-6.9)*4+rand(c,-2,2)),35,75);rival.lastRating=raw.rating;applyDevelopment(c,rival,raw.rating,raw.minutes,0);rival.age++;if(raw.rating>=7.25&&nextRandom(c)<.35){const better=CLUBS.filter(x=>x.strength>club.strength+2&&x.strength<=rival.overall+14);if(better.length)rival.clubId=pick(c,better).id;}const s={...raw,yearLabel:label,age:rival.age-1,clubId:club.id,clubName:club.name,overallStart:start,overallEnd:rival.overall,leaguePosition:pos,titles,awards};rival.history.push(s);return s;}

  function finalizeSeason(c){
    const p=c.pendingSeason;if(!p||p.currentEvent<p.events.length)throw new Error("Temporada ainda não concluída"); const club=clubById(p.clubIdAtStart),raw=c.position==="GOL"?simulateGoalkeeperStats(c,c,club,p.effects):simulateFieldStats(c,c,club,p.effects),pos=leaguePosition(c,club),team=teamSeasonStats(c,club,pos),titles=titlesFor(c,club,pos,p.competitions,c.seasonIndex),awards=awardsFor(c,c,raw,club,titles);
    ...
    const rival=simulateNpcSeason(c,c.rival,p.yearLabel),decision=clubDecision(c,stats,club),verdict=seasonVerdict(stats),clubVerdict=clubPerformanceVerdict(stats);c.age++;c.seasonIndex++;
    let contractExpired=c.contractYearsLeft<=0,renewalOffer=null,faOffers=[];
    if(decision.type==="release"){contractExpired=true;c.contractYearsLeft=0;}
    ...
    const offer=contractExpired?null:possibleOffer(c,stats);c.pendingOffer=offer;const summary={player:stats,rival,verdict,clubVerdict,clubDecision:decision,developmentText,transferOffer:offer,contractExpired,renewalOffer,freeAgentOffers:faOffers};c.lastSummary=summary;c.pendingSeason=null;
    if(c.age>=41)retireCareer(c,true); return summary;
  }

  function signContract(c,clubId,salary,years,role){c.clubId=clubId;c.salaryMonthlyBRL=salary;c.contractYearsLeft=Math.max(1,Math.min(years,41-c.age));c.coachTrust=role==="Reserva"?43:50;c.freeAgent=false;c.pendingOffer=null;c.lastSummary=null;c.careerLog.push({type:"contract",year:START_YEAR+c.seasonIndex,text:`Contrato com ${clubById(clubId).name}.`});}
  function acceptTransfer(c){const o=c.pendingOffer;if(!o)return;signContract(c,o.clubId,o.salaryMonthlyBRL,c.age<=22?5:4,o.projectedRole);c.reputation=clamp(c.reputation+2,0,100);c.morale=clamp(c.morale+4,0,100);}
  function declineTransfer(c){c.pendingOffer=null;c.lastSummary=null;}
  ...
  function migrateCareer(c){
    ...
    c.allocation=c.allocation||Object.fromEntries(attrsForPosition(c.position).map(a=>[a,Math.max(0,(c.attributes?.[a]||35)-35)]));c.developmentBias=c.developmentBias||developmentBiasFromAllocation(c.position,c.allocation);c.retired=c.retired||false;c.freeAgent=c.freeAgent||false;c.introStage=c.introStage||"complete";c.morale=c.morale??50;c.coachTrust=c.coachTrust??50;c.lastRating=c.lastRating??6.9;c.lastEventKeys=[];c.pendingSeason=null;c.lastSummary=null;c.pendingOffer=null;
    if(c.rival){c.rival.developmentBias=c.rival.developmentBias||{};c.rival.morale=c.rival.morale??50;c.rival.coachTrust=c.rival.coachTrust??50;}
    return c;
  }
  ...
  function playerHeader(minimal=false){if(!career)return"";const club=clubById(career.clubId),pos=career.secondaryPosition?`${career.position} / ${career.secondaryPosition}`:career.position;return`<header class="player-head ${minimal?"minimal":""}"><div><span class="eyebrow">${pos} · ${career.age} anos</span><h1>${escapeHtml(career.name)}</h1>${minimal?"":`<p>${club.flag} ${club.name} · ${club.leagueName} (${club.division})</p>`}</div><div class="ovr"><span>OVR</span><strong>${career.overall}</strong></div></header>`;}
  ...
  function currentRole(){return determineRole(career.overall,clubById(career.clubId),career.lastRating,career.coachTrust,career.age);}
  ...
  function renderDashboard(){
    if(career.freeAgent)return renderFreeAgency();const club=clubById(career.clubId),role=currentRole(),tot=careerTotals(career.history),season=`${START_YEAR+career.seasonIndex}/${String((START_YEAR+career.seasonIndex+1)%100).padStart(2,"0")}`,lastR=career.rival.history?.at(-1),rclub=clubById(career.rival.clubId),comps=competitionsFor(career,club);
    app().innerHTML=`<div class="shell">${brand()}${renderCurrencySelector()}${playerHeader()}${attributeCards(career)}<div class="status-grid six"><div><span>Potencial</span><strong>${career.potentialHint}</strong></div><div><span>Status</span><strong>${role}</strong></div><div><span>Forma</span><strong>${formLabel(career.form)}</strong><small>${career.form}/100</small></div><div><span>Moral</span><strong>${moraleLabel(career.morale)}</strong><small>${career.morale}/100</small></div><div><span>Reputação</span><strong>${reputationLabel(career.reputation)}</strong><small>${career.reputation}/100</small></div><div><span>Salário</span><strong>${formatMoney(career.salaryMonthlyBRL,career.currencyPreference)}/mês</strong><small>${career.contractYearsLeft} ano(s) de contrato</small></div></div>
  ...
  function renderSummary(){
    ...
    <section class="card club-review"><span class="eyebrow">AVALIAÇÃO DO CLUBE</span><h2>${s.clubDecision.title}</h2><p>${s.clubDecision.text}</p><div class="review-row"><span>Status projetado: ${p.nextRole}</span><strong>Confiança ${career.coachTrust}/100</strong></div></section>
    ...
    <section class="card rival"><span class="eyebrow">SEU RIVAL · ${p.yearLabel}</span><h2>${escapeHtml(career.rival.name)}</h2><div class="compare"><div><strong>${escapeHtml(career.name)}</strong><span>OVR ${p.overallEnd}</span><b>${p.rating.toFixed(2)}</b><small>${p.goals} G · ${p.assists} A</small></div><div class="versus">VS</div><div><strong>${escapeHtml(career.rival.name)}</strong><span>OVR ${s.rival.overallEnd}</span><b>${s.rival.rating.toFixed(2)}</b><small>${s.rival.goals} G · ${s.rival.assists} A</small></div></div></section>${contractBlock}${!s.contractExpired?transfer:""}${!s.contractExpired?`<button id="next" class="primary wide" ${s.transferOffer?"disabled":""}>Seguir para a próxima temporada</button>`:""}${career.age>=35&&career.age<41?`<button id="retire" class="ghost wide">Aposentar agora</button>`:""}</div>`;
    if($("#next"))$("#next").onclick=()=>{career.lastSummary=null;saveCareer(career);render();};if($("#accept-transfer"))$("#accept-transfer").onclick=()=>{acceptTransfer(career);saveCareer(career);render();};if($("#decline-transfer"))$("#decline-transfer").onclick=()=>{declineTransfer(career);saveCareer(career);render();};if($("#renew"))$("#renew").onclick=()=>{acceptRenewal(career);saveCareer(career);render();};if($("#free-agent"))$("#free-agent").onclick=()=>{enterFreeAgency(career);saveCareer(career);render();};if($("#retire"))$("#retire").onclick=()=>{if(confirm("Encerrar a carreira?")){retireCareer(career,false);render();}};
  }

  function transferOfferHtml(o,p){const c=clubById(o.clubId);return`<section class="card offer"><span class="eyebrow">MERCADO DA BOLA</span><h2>${c.flag} ${c.name}</h2><p>${c.leagueName} · ${c.division}</p><div class="offer-money"><span>Proposta</span><strong>${formatMoney(o.salaryMonthlyBRL,career.currencyPreference)}/mês</strong><small>Papel projetado: ${o.projectedRole}</small></div><p>${o.reason}</p><div class="actions"><button id="accept-transfer" class="primary">Aceitar</button><button id="decline-transfer">Recusar</button></div></section>`;}
  ...
  function renderFreeAgency(){const offers=career.pendingFreeAgentOffers||[];app().innerHTML=`<div class="shell narrow">${brand()}${playerHeader(true)}<section class="hero compact"><span class="eyebrow">JOGADOR LIVRE</span><h1>Mercado aberto</h1><p>Sem contrato, você pode considerar clubes melhores ou piores de acordo com espaço, momento da carreira e salário.</p></section><section class="card"><div class="club-offers">${offers.map(o=>{const c=clubById(o.clubId);return`<button class="club-offer free-choice" data-club="${c.id}"><div><strong>${c.flag} ${c.name}</strong><span>${c.leagueName} · ${c.division}</span></div><div class="offer-meta"><small>${formatMoney(o.salaryMonthlyBRL,career.currencyPreference)}/mês</small><b>${o.projectedRole}</b></div></button>`;}).join("")}</div></section>${career.age>=35?`<button id="retire" class="ghost wide">Aposentar</button>`:""}</div>`;document.querySelectorAll(".free-choice").forEach(b=>b.onclick=()=>{chooseFreeAgent(career,b.dataset.club);saveCareer(career);render();});if($("#retire"))$("#retire").onclick=()=>{retireCareer(career,false);render();};}
  ...
  return { init, calculateOverall, createCareer, startSeason, finalizeSeason, resolveEventChoice, advanceEvent, migrateCareer, CLUBS };
})();
